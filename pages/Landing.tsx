    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden text-slate-900 dark:text-white">
      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-slate-200 dark:border-[#283843] px-6 py-4 lg:px-20 bg-white dark:bg-[#131b20] sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold leading-tight tracking-[-0.015em]">LifeCompass AI</h2>
        </div>
        <div className="flex flex-1 justify-end gap-8">
          <div className="hidden md:flex items-center gap-9">
            <a href="#features" className="text-slate-500 hover:text-primary transition-colors text-sm font-medium">Возможности</a>
            <a href="#how-it-works" className="text-slate-500 hover:text-primary transition-colors text-sm font-medium">Как это работает</a>
            <a href="#assessments" className="text-slate-500 hover:text-primary transition-colors text-sm font-medium">Методики</a>
          </div>
        ...
        <div className="w-full max-w-[1200px] flex flex-col lg:flex-row gap-10 items-center">
            <div className="flex flex-col gap-6 lg:w-1/2 text-left z-10">
                <div className="inline-flex w-fit items-center gap-2 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#1d2830] px-3 py-1 text-xs font-medium text-primary shadow-sm">
                    ...
                    <span>AI-Анализ 2.0</span>
                </div>
                <h1 className="text-4xl lg:text-6xl font-black leading-[1.1] tracking-[-0.033em]">
                    Построй карьеру мечты <br/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-500">с помощью науки</span>
                </h1>
                <p className="text-slate-500 text-lg font-normal leading-relaxed max-w-[540px]">
                    Профессиональная психодиагностика и профориентация. Объединяем проверенные методики и современные технологии для точного результата.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    ...
                    <a href="#how-it-works" className="flex items-center justify-center rounded-xl h-12 px-8 bg-white dark:bg-[#1d2830] border border-slate-200 dark:border-slate-700 hover:bg-slate-50 transition-colors text-slate-900 dark:text-white text-base font-bold shadow-sm">
            ...
            <div className="lg:w-1/2 w-full relative">
                ...
                <div className="relative w-full aspect-square lg:aspect-[4/3] bg-white dark:bg-[#1e272e] rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-2xl">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-white/90 dark:bg-[#131b20]/90 backdrop-blur-md p-4 rounded-xl border border-slate-200 dark:border-slate-700 flex items-center gap-4 shadow-lg">
                        ...
                        <div>
                            <div className="text-sm font-bold">Глубокий анализ</div>
                            <div className="text-slate-500 text-xs">На основе Big Five и Holland Code</div>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <section className="px-6 py-16 bg-background-light dark:bg-background-dark" id="how-it-works">
         <div className="max-w-[1200px] mx-auto text-center">
            <div className="flex flex-col gap-4 mb-12 items-center">
                <h2 className="text-primary font-bold tracking-wider uppercase text-sm">Процесс</h2>
                <h1 className="text-3xl md:text-4xl font-black tracking-tight max-w-[720px]">От ответов к инсайтам</h1>
                <p className="text-slate-500 text-base font-normal max-w-[600px]">Мы используем научно обоснованные алгоритмы для построения вашей карты компетенций.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                {[
                    { step: 1, title: "Выберите методику", desc: "Определитесь с форматом: классический тест с вопросами или свободный диалог с AI-ассистентом.", icon: "touch_app", color: "text-primary", bg: "bg-primary/10" },
                    { step: 2, title: "Пройдите оценку", desc: "Ответьте на вопросы честно. ИИ анализирует ваши ответы и сопоставляет с профессиональными профилями.", icon: "psychology", color: "text-purple-500", bg: "bg-purple-500/10" },
                    { step: 3, title: "Получите результат", desc: "Развёрнутый отчёт с архетипом, сильными сторонами и рекомендациями по карьерному развитию.", icon: "description", color: "text-emerald-500", bg: "bg-emerald-500/10" }
                ].map((item) => (
      ...
      <section className="px-6 py-16 bg-white dark:bg-[#131b20] border-y border-slate-100 dark:border-[#283843]" id="assessments">
        <div className="max-w-[1200px] mx-auto text-center">
          <div className="flex flex-col gap-4 mb-12 items-center">
            ...
            <h1 className="text-3xl md:text-4xl font-black tracking-tight max-w-[720px]">5 проверенных методик</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
            {[
              ...
              <div key={i} className={`flex flex-col rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-background-light dark:bg-[#1d2830] hover:shadow-lg transition-all duration-300 ${i === 4 ? 'md:col-start-2 lg:col-start-auto' : ''}`}>
      ...
      <footer className="bg-white dark:bg-[#131b20] border-t border-slate-200 dark:border-[#283843] py-12 px-6">
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-bold">LifeCompass AI</h3>
                </div>
                <p className="text-slate-500 text-sm leading-relaxed">Профессиональная платформа психодиагностики и профориентации на базе искусственного интеллекта.</p>
            </div>
            <div className="flex flex-col gap-3">
                ...
                <a href="#features" className="text-slate-500 hover:text-primary text-sm transition-colors">Возможности</a>
                <a href="#how-it-works" className="text-slate-500 hover:text-primary text-sm transition-colors">Как это работает</a>
            </div>
            <div className="flex flex-col gap-3">
                <h4 className="font-bold text-sm">Методики</h4>
                <a href="#assessments" className="text-slate-500 hover:text-primary text-sm transition-colors">RIASEC</a>
                <a href="#assessments" className="text-slate-500 hover:text-primary text-sm transition-colors">Big Five</a>
                <a href="#assessments" className="text-slate-500 hover:text-primary text-sm transition-colors">Soft Skills 360</a>
            </div>
            <div className="flex flex-col gap-3">
                <h4 className="font-bold text-sm">Поддержка</h4>
                ...
                <a href="#" className="text-slate-500 hover:text-primary text-sm transition-colors">Конфиденциальность</a>
            </div>
          </div>
          <div className="border-t border-slate-200 dark:border-[#283843] pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-xs">LifeCompass AI. Все данные хранятся локально на вашем устройстве.</p>
